...
| #20 broader selector | — | **20/20 PASS** (filter expansion only; includes B6 no-cleanup architecture guard mentioning `#20`) | `-t "#20"` |
...
| PLAYWRIGHT Stage-B + T508 | **21** | **20/21 PASS** | `e2e/t010403-stage-b-seam.spec.ts` + `e2e/t010508-phase5-parity.spec.ts` (1 rollback snapshot ordering flake; unrelated to #16) |
| FULL CHECK | **2121** | **2121/2121 PASS** | `npm run check` |
