...
| 16 | `ClientPortal.ts` | 937 | client-facing portal | 14 | 1 (`opportunityScoutConsumer`) | no | mixed | clientId | **MEDIUM** (`theses[0]` presentation default) | **HIGH** | `<ClientPortal/>` route tree | **3** | **HYBRID · HYBRID_MIGRATABLE** (T-010-304 — `ReactClientPortalPage`; 6 canonical commands migrated incl. #19 ack, 6 blocked, registry #13/#28/#30/#32; `theses[0]` default replaced by explicit selection; P1 #19 React presentation parity accepted) |
