...
**Phase 2:** application use cases + central path.  
**Phase 3:** persistence + material routing history — see status column.
...
|---|-----------|---------|--------|
| A1 | Every production signal routing execution evaluates all eligible ACTIVE theses | Multi-thesis · Eligibility | ✅ Phase 2–3 (central path); remaining agents Phase 4 |
...
| A4 | A contested result cannot silently become a final thesis attribution through first/primary fallback | Contested policy | ✅ Phase 2–3 (no stale thesisId; history on transition) |
| A5 | Routing persists complete per-thesis scoring evidence plus routing decision/rationale | Explainability | ✅ Phase 3 (thesisScores + routingDecision on Signal) |
| A6 | Manual override is explicitly marked MANUAL and auditable | Human override | ✅ Phase 3 history + actorId |
| A7 | `SIGNAL_THESIS_EVAL` remains advisory and cannot replace deterministic routing | AI boundary · SPEC-005 | ✅ Router path AI-free; no AI in history |
| A8 | Domain routing remains infrastructure/framework pure | Hexagonal | ✅ Phase 1 + `routingHistoryCore` |
| A9 | Application depends on ports rather than concrete Firestore/db adapters | Hexagonal | ✅ Phase 2–3 |
| A10 | Routing outputs include an algorithm/routing version | Explainability | ✅ Phase 1–3 |
| A11 | Material routing changes preserve history/audit evidence | History | ✅ Phase 3 local history store |
| A12 | Routing alone cannot silently perform an unauthorized terminal DISCARD | Auto-discard governance | ✅ Phase 2–3 |
| A13 | Tenant envelope remains consistent with SPEC-009 contracts | Tenant | ✅ Phase 3 tenant checks on write; envelope unchanged |
...
| A15 | Multi-thesis tests cover 1, 2, and N ACTIVE theses | Tests | ✅ Phase 1–3 |
| A16 | Contested + manual override tests PASS | Tests | ✅ Phase 2–3 |
| A17 | `npm run check` PASS | Governance | ✅ **534/534** at Phase 3 checkpoint |
