...
**Phase 3:** Persistence + score history implemented (partial acceptance advance).  
...
| A12 | Scoring persistence alone cannot silently perform terminal DISCARD | Auto-discard | ☐ Partial — governed Application paths ban DISCARD; legacy `applyScoreToSignal` remains Phase 4 |
...
| A17 | AI remains advisory; deterministic score remains authoritative | SPEC-005 boundary | ✅ Phase 2 — no AI in Application scoring use cases |
