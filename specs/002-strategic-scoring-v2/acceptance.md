...
**Phase 2:** Application governance implemented (partial acceptance advance).  
...
| A16 | Tenant mismatch at scoring persistence boundary is rejected | Tenant | ☐ Partial — Application boundary validates Phase 2; persistence Phase 3 |
