...
|---|-----------|---------|--------|
| A1 | Same material inputs + `scoringVersion` produce same material score | Determinism | ☐ Phase 1+ |
| A2 | Single canonical deterministic algorithm used by all strategic scoring execution paths | Parity | ☐ Phase 1/4 |
...
| A9 | Every material score result records `scoringVersion` | Versioning | ☐ Phase 1+ |
| A10 | Score explainability reconstructs factors, penalties, total | Explainability | ☐ Phase 1+ |
| A11 | Strategic disposition and output/content format are separate contracts | Disposition split | ☐ Phase 1+ |
...
| A18 | Domain scoring is infrastructure/framework pure | Hexagonal | ☐ Phase 1+ |
...
| Human SPEC approver | | ☐ **PENDING** (T-002-010) |
| CODE_COMPLETE human | | ☐ (Phase 6) |

**Current:** `READY_FOR_HUMAN_SPEC_APPROVAL` · **NOT** `READY_FOR_IMPLEMENTATION`
